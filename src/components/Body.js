                    ...
                    <div class="md:flex">
                      <div class="md:shrink-0">
                        <img
                          ...
                          alt="Modern eCommerce architecture"
                        />
                      </div>
                      <div class="p-8">
                        <h5 className="tracking-wide font-redhatregular text-black text-lg mb-5">
                          eCommerce site integrated with G-bucket
                        </h5>
                        <div class="grid grid-cols-2 gap-5">
                          <div>
                            <p className="tracking-wide text-cyan-500 font-redhatregular text-black text-base mb-5">
                            ...
                            <div>
                              <div class="grid grid-cols-2 gap-0">
                                <div>
                                  <a
                                    href="https://github.com/Un-Knwn-me/madmonkeyz-client-vite"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
                                ...
                                <div>
                                  <a
                                    href="https://madmonkez.netlify.app/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
                          ...
                          <div>
                            ...
                            <div>
                              <div class="grid grid-cols-2 gap-0">
                                <div>
                                  <a
                                    href="https://github.com/Un-Knwn-me/FirstLook-server-side"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <span>
                                ...
                                <div>
                                  <a
                                    href="https://madmonkez-server-153001c412bc.herokuapp.com/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
                  ...
                  <div class="my-20 max-w-md mx-auto rounded-xl overflow-hidden md:max-w-2xl">
                    <div class="md:flex">
                      <div class="md:shrink-0">
                        <img
                          class="h-48 w-full object-cover md:h-full md:w-48"
                          src="https://images.pexels.com/photos/9654933/pexels-photo-9654933.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                          alt="Modern class room"
                        />
                      </div>
                      <div class="p-8">
                        <h5 className="tracking-wide font-redhatregular text-black text-lg mb-5">
                          Training Booking (MySql)
                        </h5>
                        <div class="grid grid-cols-2 gap-5">
                          <div>
                            <p className="tracking-wide text-cyan-500 font-redhatregular text-black text-base mb-5">
                            ...
                            <div>
                              <div class="grid grid-cols-2 gap-0">
                                <div>
                                  <a
                                    href="https://github.com/Un-Knwn-me/training-schedule-frontend"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
                                ...
                                <div>
                                  <a
                                    href="https://book-trainingschedule.netlify.app/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
                          ...
                          <div>
                            ...
                            <div>
                              <div class="grid grid-cols-2 gap-0">
                                <div>
                                  <a
                                    href="https://github.com/Un-Knwn-me/training-schedule-backend"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <span>
                                ...
                                <div>
                                  <a
                                    href="https://training-t4qx.onrender.com"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  >
                                    <svg
      ...
      <footer id="contact">
        <div className="relative isolate overflow-hidden bg-white py-10 px-10 md:px-40">
          <div className="grid md:grid-cols-12 gap-10 text-black text-start">
            ...
            <div className="text-center col-span-12 md:col-span-4 mx-auto">
              <a
                href='https://drive.google.com/file/d/1iNh1dHpr1_h5fXoB4gNpo8yBuXh7xxJT/view?usp=sharing'
                target='_blank'
                rel="noopener noreferrer"
